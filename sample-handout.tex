...
\smallcaps{examplore} will be the first of a series of tools that transform the modern language, library, and API design, selection, and usage experience for all who program. Björn Hartmann, Miryung Kim, my postdoc Tianyi Zhang, and I are working on new tools for helping programmers (1) use APIs in a particular context, (2) design and evolve an API, and (3) assess an API or select between multiple APIs with similar capabilities.
